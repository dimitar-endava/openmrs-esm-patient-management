...
const createSchema = (t: TFunction) => {
  ...
  return z.object({
    ...
    bedCondition: z.string().refine((value) => value.trim() !== '', {
      message: t('invalidBedCondition', 'Please enter a valid bed condition'),
    }),
  });
};
...
const BedAdministrationForm: React.FC<BedAdministrationFormProps> = ({
  ...
  const {
    ...
    defaultValues: {
      ...
      bedCondition: initialData.condition ?? '',
    },
  });
              ...
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <TextInput
                    ...
                    placeholder={t('enterBedCondition', 'e.g. Good condition')}
                    invalidText={fieldState.error?.message}
                    {...field}
                  />
                )}
